...
window.onload = function() {
  ...
  // Click event
  fileInput.addEventListener("change", function start() {
    ...
    if (file.type.match(imageType)) {
      ...
      reader.onload = function() {
        ...
        document.getElementById(string + i).addEventListener("click", function() {
          ...
          document.getElementById(string + i).style.filter = "brightness(.4)";
        ...
        // Add X button
        fileDisplayArea.innerHTML = fileDisplayArea.innerHTML + "<div id='x"+ i +"' className=''>X</div>";
